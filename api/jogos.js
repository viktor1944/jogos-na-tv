Sim, faz todo sentido! O último `&#8211;` sempre separa a liga, independente de quantos travessões tiver antes. Edita o `api/jogos.js` no GitHub e substitui tudo por:
...
function extrair(html) {
  ...
  while ((m = re.exec(html)) !== null) {
    ...
    // Divide pelo separador &#8211; e pega o ULTIMO como liga
    var partes = titulo.split('&#8211;');
    
    // Se so tem uma parte, tenta com o travessao unicode que pode ter vindo decodificado
    if (partes.length === 1) {
      partes = titulo.split('\u2013');
    }
    ...
    // Limpa espacos e caracteres extras
